...
class Plant(models.Model):
    ...
    light = models.CharField(max_length=256, blank=True)
    soil = models.CharField(max_length=256, blank=True)
    exposure = models.CharField(max_length=256, blank=True)
    hardiness = models.CharField(max_length=256, blank=True)
    propagation = models.CharField(max_length=256, blank=True)

    regions = models.CharField(max_length=256, blank=True)
    zones = models.CharField(max_length=256, blank=True)
    habit = models.CharField(max_length=256, blank=True)

    organ = models.CharField(max_length=256, blank=True)
    fruit = models.CharField(max_length=256, blank=True)
    leaf = models.TextField(blank=True)
    foliage = models.TextField(blank=True)
    flower = models.TextField(blank=True)
    flower_color = models.CharField(max_length=256, blank=True)
    color = models.CharField(max_length=256, blank=True)
    fronds = models.TextField(blank=True)
    texture = models.CharField(max_length=256, blank=True)
    form = models.CharField(max_length=256, blank=True)
    sub_type = models.CharField(max_length=256, blank=True)
    fragrance = models.CharField(max_length=256, blank=True)
    inflorescence = models.CharField(max_length=256, blank=True)

    season = models.CharField(max_length=256, blank=True)
    flowering_period = models.CharField(max_length=256, blank=True)
    storage = models.TextField(blank=True)
    usage = models.CharField(max_length=256, blank=True)

    # poison
    family = models.CharField(max_length=256, blank=True)
    description = models.TextField(blank=True)
    origin = models.CharField(max_length=256, blank=True)
    distribution = models.CharField(max_length=256, blank=True)
    found = models.CharField(max_length=256, blank=True)
