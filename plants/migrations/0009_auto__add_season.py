...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Season'
        db.create_table(u'plants_season', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('season', self.gf('django.db.models.fields.CharField')(max_length=16)),
        ))
        db.send_create_signal(u'plants', ['Season'])

        # Adding M2M table for field search_season on 'Plant'
        db.create_table(u'plants_plant_search_season', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('plant', models.ForeignKey(orm[u'plants.plant'], null=False)),
            ('season', models.ForeignKey(orm[u'plants.season'], null=False))
        ))
        db.create_unique(u'plants_plant_search_season', ['plant_id', 'season_id'])


    def backwards(self, orm):
        # Deleting model 'Season'
        db.delete_table(u'plants_season')

        # Removing M2M table for field search_season on 'Plant'
        db.delete_table('plants_plant_search_season')
    ...
    models = {
        ...
        u'plants.plant': {
            ...
            'search_season': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['plants.Season']", 'symmetrical': 'False'}),
