...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plant.drought_tolerant'
        db.add_column(u'plants_plant', 'drought_tolerant',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plant.drought_tolerant'
        db.delete_column(u'plants_plant', 'drought_tolerant')
