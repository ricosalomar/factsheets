...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plant.search_season'
        db.add_column(u'plants_plant', 'search_season',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plant.search_season'
        db.delete_column(u'plants_plant', 'search_season')
    ...
    models = {
        ...
        u'plants.plant': {
            ...
            'search_season': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
