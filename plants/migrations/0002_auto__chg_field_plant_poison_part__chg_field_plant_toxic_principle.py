...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Plant.poison_part'
        db.alter_column(u'plants_plant', 'poison_part', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Plant.toxic_principle'
        db.alter_column(u'plants_plant', 'toxic_principle', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Plant.poison_part'
        db.alter_column(u'plants_plant', 'poison_part', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Plant.toxic_principle'
        db.alter_column(u'plants_plant', 'toxic_principle', self.gf('django.db.models.fields.CharField')(max_length=128))
