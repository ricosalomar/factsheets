...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Light'
        db.create_table(u'plants_light', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('light', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'plants', ['Light'])
        ...
        # Adding M2M table for field search_flower_color on 'Plant'
        db.create_table(u'plants_plant_search_flower_color', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('plant', models.ForeignKey(orm[u'plants.plant'], null=False)),
            ('color', models.ForeignKey(orm[u'plants.color'], null=False))
        ))
        db.create_unique(u'plants_plant_search_flower_color', ['plant_id', 'color_id'])

        # Adding M2M table for field search_leaf_color on 'Plant'
        db.create_table(u'plants_plant_search_leaf_color', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('plant', models.ForeignKey(orm[u'plants.plant'], null=False)),
            ('color', models.ForeignKey(orm[u'plants.color'], null=False))
        ))
        db.create_unique(u'plants_plant_search_leaf_color', ['plant_id', 'color_id'])

        # Adding M2M table for field search_light on 'Plant'
        db.create_table(u'plants_plant_search_light', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('plant', models.ForeignKey(orm[u'plants.plant'], null=False)),
            ('light', models.ForeignKey(orm[u'plants.light'], null=False))
        ))
        db.create_unique(u'plants_plant_search_light', ['plant_id', 'light_id'])


    def backwards(self, orm):
        # Deleting model 'Light'
        db.delete_table(u'plants_light')
        ...
        # Removing M2M table for field search_flower_color on 'Plant'
        db.delete_table('plants_plant_search_flower_color')

        # Removing M2M table for field search_leaf_color on 'Plant'
        db.delete_table('plants_plant_search_leaf_color')

        # Removing M2M table for field search_light on 'Plant'
        db.delete_table('plants_plant_search_light')
    ...
    models = {
        ...
        u'plants.light': {
            'Meta': {'ordering': "('light',)", 'object_name': 'Light'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'light': ('django.db.models.fields.CharField', [], {'max_length': '64'})
        },
        u'plants.oldurl': {
        ...
        u'plants.plant': {
            ...
            'search_flower_color': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'plant_flower_color'", 'symmetrical': 'False', 'to': u"orm['plants.Color']"}),
            'search_leaf_color': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'plant_leaf_color'", 'symmetrical': 'False', 'to': u"orm['plants.Color']"}),
            'search_light': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['plants.Light']", 'symmetrical': 'False'}),
